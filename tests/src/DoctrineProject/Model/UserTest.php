...
use DoctrineProject\Test\TestCase;
use DoctrineProject\Model\User;
...
class UserTest extends TestCase
{
    ...
    public function buildCourse($courseName)
    {
